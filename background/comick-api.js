...
function normalizeComic(payload) {
    ...
    const comic = payload.comic && typeof payload.comic === 'object'
        ? payload.comic
        : payload;
...
export { searchComic, getComicBySlug, getChapters, getUserFollows, getUserFollowComic, findChapter, markChapterRead };
